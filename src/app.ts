...
import GraphicsManagement from "./Core/GraphicsManagement";
import Sprite = GraphicsManagement.Sprite;
import SceneManagement from "./Core/SceneManagement";
import Scene = SceneManagement.Scene;

class Match3 extends Scene {
    private level : any = {};
    private tileSprites = [
        'img.png',
    ];
...
window.onload = function () {
    ...
    engine.Init();
    let scene1 = new Match3(engine,params);
